---
name: gsap
description: Advanced GSAP motion engineering for cinematic landing pages, editorial scroll stories, pinned sections, scrubbed timelines, animated product showcases, and high-polish interaction choreography. Use when the user explicitly wants GSAP, ScrollTrigger, pinned scroll, cinematic motion, immersive storytelling, or award-level animated UI.
---

# GSAP Motion Skill

Use this skill for high-motion interfaces. For ordinary hover, loading, route, and state transitions, use `animate` instead.

## 1. Design Intelligence Gate

Before writing GSAP code:

1. Use `design-intelligence` to confirm the product, audience, tone, density, and motion level.
2. Use `design` for the visual system.
3. Use this skill only if the motion should be cinematic, scroll-driven, pinned, scrubbed, or deeply choreographed.
