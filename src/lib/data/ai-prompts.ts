...
let _id = 0;
const p = (f: Omit<AiPromptTemplate, 'id'>): AiPromptTemplate => ({ id: String(++_id), ...f });
...
export const AI_PROMPT_TEMPLATES: AiPromptTemplate[] = [
  ...
  p({
    ...
    description: 'Identify the most exploitable services from an Nmap / recon dump',
    prompt:
  ...
  p({
    ...
    description: 'Get targeted exploit suggestions for a specific service or CVE',
    prompt:
  ...
  p({
    ...
    description: 'Troubleshoot a payload or exploit that is not working as expected',
    prompt:
  ...
  p({
    ...
    description: 'Get a ranked list of Linux PrivEsc paths from enumeration output',
    prompt:
  ...
  p({
    ...
    description: 'Get a ranked list of Windows PrivEsc paths from enumeration output',
    prompt:
  ...
  p({
    ...
    description: 'Generate a tailored post-exploitation checklist after gaining a foothold',
    prompt:
  ...
  p({
    ...
    description: 'Plan an end-to-end Kerberoast attack from SPN enumeration to DA',
    prompt:
  ...
  p({
    ...
    description: 'Turn raw notes into a polished pentest finding with CVSS and remediation',
    prompt:
  ...
  p({
    ...
    description: 'Produce an executive-friendly summary of all findings in the note',
    prompt:
