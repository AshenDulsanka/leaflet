...
The `caveman` compression subflow receives a Snyk High Risk rating due to static analysis heuristics. This document explains what the subflow does and does not do.
